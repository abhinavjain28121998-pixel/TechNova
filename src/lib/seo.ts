export const BASE_URL = (typeof process !== "undefined" && process.env.VITE_SITE_URL) ? process.env.VITE_SITE_URL : (import.meta as any).env?.VITE_SITE_URL || "https://tech-nova-iota.vercel.app";
